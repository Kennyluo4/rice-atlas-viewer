...
if (input_1_users_select_cate != 'ACR'){
  ...
  plot.act.scores    <- function(meta_fl,output_dir,
    ...
    for (i in 1:length(gids)){
      ...
      tiff(paste0(output_dir,'/',outname,".trajectory.",input_1_users_select_cate,".tiff"), width =24, height = 30,res = 200, units = 'cm')
      par(cex = 1.5)
  ...
  plot.act.scores(meta_fl,input_output_dir,
                  ...
                  lim=lim,
                  marker.dist=NULL,
                  outname=paste0(input_2_users_select_path_name,".trajectory",input_1_users_select_cate,"UMAP.tiff"))
